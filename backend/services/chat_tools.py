...
from services.amap_weather import WEATHER_TOOL, execute_weather_tool
from services.deepseek import DeepSeekError, chat_completion

MAX_TOOL_ROUNDS = 3
TOOLS_ENABLED_MODELS = {"deepseek-chat"}

AVAILABLE_TOOLS: list[dict[str, Any]] = [WEATHER_TOOL]
...
# re-export for callers that expect DeepSeekError nearby
__all__ = [
    "AVAILABLE_TOOLS",
    "MAX_TOOL_ROUNDS",
    "DeepSeekError",
